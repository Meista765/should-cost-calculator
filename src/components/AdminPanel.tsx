...
const META_COLS:    ColDef<MaterialMetaRow>[]     = [{ key:'grade', label:'강종', kind:'str', w:'140px' }, { key:'displayName', label:'강종명', kind:'str' }, { key:'cutKey', label:'절단 키', kind:'sel', opts:['', ...CUT_KEYS] }, { key:'group', label:'재질군', kind:'sel', opts:['','탄소강','컬러강판','STS','비철'], w:'80px' }, { key:'density', label:'비중(g/cm³)', kind:'num', w:'100px' }];
